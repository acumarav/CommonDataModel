...
LEFT JOIN (
	...
	FROM cdm531.concept c1
	INNER JOIN cdm531.concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
		AND c1.domain_id = 'Condition'
		AND ca1.min_levels_of_separation = 1
	INNER JOIN cdm531.concept c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN cdm531.concept soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN cdm531.concept atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
FROM (
	SELECT DISTINCT
		concept_id,
		concept_name
	FROM cdm531.concept c
	WHERE domain_id = 'Measurement'
) m
LEFT JOIN cdm531.concept_ancestor ca1 ON M.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN cdm531.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN cdm531.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN cdm531.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN cdm531.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
LEFT JOIN cdm531.concept c3 ON ca3.ANCESTOR_CONCEPT_ID = c3.concept_id
...
LEFT JOIN cdm531.concept_ancestor ca1 ON obs.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN cdm531.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN cdm531.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN cdm531.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN cdm531.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
...
(
	...
	FROM cdm531.concept c1
	INNER JOIN cdm531.vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
	...
	FROM cdm531.concept_ancestor ca0
	INNER JOIN (
		SELECT DISTINCT c2.concept_id AS os3_concept_id
		FROM cdm531.concept_ancestor ca1
		INNER JOIN cdm531.concept c1 ON ca1.DESCENDANT_CONCEPT_ID = c1.concept_id
		INNER JOIN cdm531.concept_ancestor ca2 ON c1.concept_id = ca2.ANCESTOR_CONCEPT_ID
		INNER JOIN cdm531.concept c2 ON ca2.DESCENDANT_CONCEPT_ID = c2.concept_id
